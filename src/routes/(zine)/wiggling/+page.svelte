<script lang="ts">
	...
	// Voices come through the ContentService port (see src/lib/content/wiggling.ts
	// for the source data and the notes on reel hosting and poster frames).
	//
	...
	const voices = $derived(data.voices);

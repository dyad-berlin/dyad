...
export const POST: RequestHandler = async ({ request, locals, url }) => {
	...
	// Membership is open to anyone who wants to support dyad — no location gate.
	// (It was Berlin-only via a self-declared checkout gate; removed so people
	// outside Berlin can support too. Participation and discovery were never
	// location-gated — discovery stays region-scoped as a view, not an access gate.)
